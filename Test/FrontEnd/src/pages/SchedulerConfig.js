            ...
            <Box className={classes.rootBox} bgcolor="background.darker" boxShadow={2} borderRadius="20px" >
                ...
                {isLoaded ?
                    data.length!==0?
                        ...
                        :
                        <>
                            <Typography variant="h6" align={"center"} style={{marginTop:25}}>There is no Schedulers</Typography>
                            <Typography variant="h6" gutterBottom align={"center"} >You can add one on each of the switches</Typography>
                        </>
