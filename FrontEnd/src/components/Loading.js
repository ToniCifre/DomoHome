...
class Loader extends React.Component {
    ...
    positionForTile(radioCommand){
        for(let position in this.state.positions){
            if(this.state.positions[position] === radioCommand){
                return position;
            }
        }
    }
    ...
    render() {
        ...
        const { size, style, center, open } = this.props;
